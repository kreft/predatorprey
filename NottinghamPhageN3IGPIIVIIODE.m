function dy = NottinghamPhageN3IGPIIVIIODE(t, y, sP)
...
% others which develop persistence to predation and two predators both
% exhibiting a Holling type II functional response and a seperate bdelloplast
% / infected cell stage. One also has mortality
% simModes = 4, 5, 7 and 14
%
% function dy = NottinghamPhageN3IGPIIVIIODE(t, y, sP)
%
...
dPred2 = sP.kV * infCell - ...
    ...
    ((sP.Knv + senPrey + bdPersistPrey + phageResPrey) * sP.yieldIPerV);
